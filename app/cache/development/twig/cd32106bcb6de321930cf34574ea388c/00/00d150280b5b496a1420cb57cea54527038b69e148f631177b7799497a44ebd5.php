...
class __TwigTemplate_7e5add8ec6b28e162ed66fbf7fd64913b6a8d8f3da68f11b775c27f3150b5606 extends Twig_Template
{
                    ...
                    <form class=\"form-inline d-block m-auto\" target=\"_self\">
                        <div class=\"form-group\" style=\"background-color:#ffffff;margin-top:20px;\">
                            ...
                            <div class=\"dropdown\">
                                ";
        // line 16
        echo "                                <button class=\"btn btn-light dropdown-toggle\" data-toggle=\"dropdown\" aria-expanded=\"false\" type=\"button\" style=\"background-color:rgba(248,249,250,0);color:rgb(73,80,87);margin-right:10px;margin-left:10px;\">Kategorien</button>
...
";
    ...
    {
        return new Twig_Source("<div class=\"align-items-stretch align-content-stretch visible\" id=\"welcome\">
            <div class=\"jumbotron jumbotron-fluid\" style=\"margin-bottom:0;\">
                <h1>Willkommen bei Independent Tutorials</h1>
                <div class=\"container-fluid d-inline-flex\">
                    <form class=\"form-inline d-block m-auto\" target=\"_self\">
