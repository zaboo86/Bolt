...
class __TwigTemplate_b7a56386f580fad3da6b5747dbcf1b049065889723473b1431eb4345077b54bb extends Twig_Template
{
    ...
    ";
      ...
      ";
       ...
       ";
            // line 10
            $context['pageitems'] = $this->env->getExtension('Bolt\Twig\Extension\BoltExtension')->getStorage()->getContent("pages/latest/6", array() );
            // line 11
            echo "
...
{% block main %}
    ...
    {% if record is defined %}
      ...
      {#  <h1>{{ record.title }}</h1>#}
       ...
       {% setcontent pageitems = \"pages/latest/6\" %}
...
<article>
   ...
   {% if pageitem.image!=\"\" %}
    ...
    {% endif %}
    {{ pageitem.excerpt }}
    <a href=\"{{ pageitem.link }}\" class=\"action\"><i class=\"fa fa-arrow-circle-right\"></i></a>
