...
class __TwigTemplate_0c5c3f716854ef16a487762260cb79d3813b376dda343c8dfbc9e262643e2f8a extends Twig_Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02->enter($__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02_prof = new Twig_Profiler_Profile($this->getTemplateName(), "template", "@BoltProfiler/config.html.twig"));

        $tags = array("set" => 17, "spaceless" => 28, "include" => 44, "if" => 66, "for" => 142);
        $filters = array("escape" => 31, "sort" => 142, "keys" => 142);
        $functions = array("path" => 19);

        try {
            $this->env->getExtension('Twig_Extension_Sandbox')->checkSecurity(
                array('set', 'spaceless', 'include', 'if', 'for'),
                array('escape', 'sort', 'keys'),
                array('path')
            );
...
.sf-toolbar-block-config .sf-toolbar-info {
    ...
    ";
        ...
        <a href=\"";
        // line 19
        echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("_profiler_phpinfo"));
        echo "\">
    ...
    ";
        ...
        echo "            <div class=\"sf-toolbar-info-piece sf-toolbar-info-php\">
                ...
                <span>";
        // line 31
        echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed(twig_escape_filter($this->env, $this->getAttribute(($context["collector"] ?? null), "phpversion", array()), "html", null, true));
        echo "</span>
            </div>
        ...
        // line 35
        echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed((($this->getAttribute(($context["collector"] ?? null), "hasxdebug", array())) ? ("green") : ("red")));
        echo "\">xdebug</span>
                <span class=\"sf-toolbar-status sf-toolbar-status-";
        // line 36
        echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed((($this->getAttribute(($context["collector"] ?? null), "hasaccelerator", array())) ? ("green") : ("red")));
        echo "\">accel</span>
            </div>
            <div class=\"sf-toolbar-info-piece\">
                ...
                <span>";
        // line 40
        echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed(twig_escape_filter($this->env, $this->getAttribute(($context["collector"] ?? null), "sapiName", array()), "html", null, true));
        echo "</span>
            </div>
        ";
...
";
    ...
    <table>
        ...
        if ($this->getAttribute(($context["collector"] ?? null), "applicationname", array())) {
            ...
            echo "                <th>Application</th>
                <td>";
            // line 68
            echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed(twig_escape_filter($this->env, $this->getAttribute(($context["collector"] ?? null), "applicationname", array()), "html", null, true));
            echo " ";
            echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed(twig_escape_filter($this->env, $this->getAttribute(($context["collector"] ?? null), "applicationversion", array()), "html", null, true));
            echo " (on Symfony ";
            echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed(twig_escape_filter($this->env, $this->getAttribute(($context["collector"] ?? null), "symfonyversion", array()), "html", null, true));
            echo ")</td>
            ";
        } else {
            // line 70
        ...
        if (("n/a" != $this->getAttribute(($context["collector"] ?? null), "appname", array()))) {
            ...
            echo "            <tr>
                ...
                <td>";
            // line 77
            echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed(twig_escape_filter($this->env, $this->getAttribute(($context["collector"] ?? null), "appname", array()), "html", null, true));
            echo "</td>
            </tr>
        ";
        }
        ...
        if (("n/a" != $this->getAttribute(($context["collector"] ?? null), "env", array()))) {
            ...
            echo "            <tr>
                ...
                <td>";
            // line 83
            echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed(twig_escape_filter($this->env, $this->getAttribute(($context["collector"] ?? null), "env", array()), "html", null, true));
            echo "</td>
            </tr>
        ";
        }
        ...
        if (("n/a" != $this->getAttribute(($context["collector"] ?? null), "debug", array()))) {
            ...
            echo "            <tr>
                ...
                <td>";
            // line 89
            echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed((($this->getAttribute(($context["collector"] ?? null), "debug", array())) ? ("enabled") : ("disabled")));
            echo "</td>
            </tr>
        ";
        }
    ...
    <table>
        ...
        <tr>
            ...
            <td>";
        // line 106
        echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed((($this->getAttribute(($context["collector"] ?? null), "hasxdebug", array())) ? ("enabled") : ("disabled")));
        echo "</td>
        </tr>
        <tr>
            ...
            <td>";
        // line 110
        echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed((($this->getAttribute(($context["collector"] ?? null), "hasaccelerator", array())) ? ("enabled") : ("disabled")));
        echo "</td>
        </tr>
        <tr>
            <th>XCache</th>
            <td>";
        // line 114
        echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed((($this->getAttribute(($context["collector"] ?? null), "hasxcache", array())) ? ("enabled") : ("disabled")));
        echo "</td>
        </tr>
        <tr>
            <th>APC</th>
            <td>";
        // line 118
        echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed((($this->getAttribute(($context["collector"] ?? null), "hasapc", array())) ? ("enabled") : ("disabled")));
        echo "</td>
        </tr>
        <tr>
            <th>Zend OPcache</th>
            <td>";
        // line 122
        echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed((($this->getAttribute(($context["collector"] ?? null), "haszendopcache", array())) ? ("enabled") : ("disabled")));
        echo "</td>
        </tr>
        <tr>
            <th>EAccelerator</th>
            <td>";
        // line 126
        echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed((($this->getAttribute(($context["collector"] ?? null), "haseaccelerator", array())) ? ("enabled") : ("disabled")));
        echo "</td>
        </tr>
        <tr>
    ...
    ";
        ...
        <table>
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["name"]) {
                ...
                <td>";
                // line 145
                echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed(twig_escape_filter($this->env, $this->getAttribute(($context["bundles"] ?? null), $context["name"], array(), "array"), "html", null, true));
                echo "</td>
            </tr>
            ";
            }
    ...
    {
        return array (  345 => 148,  336 => 145,  332 => 144,  329 => 143,  324 => 142,  322 => 141,  314 => 135,  312 => 134,  305 => 130,  298 => 126,  291 => 122,  284 => 118,  277 => 114,  270 => 110,  263 => 106,  256 => 102,  244 => 92,  238 => 89,  234 => 87,  231 => 86,  225 => 83,  221 => 81,  218 => 80,  212 => 77,  208 => 75,  206 => 74,  203 => 73,  198 => 71,  195 => 70,  186 => 68,  183 => 67,  181 => 66,  172 => 59,  166 => 58,  152 => 49,  146 => 48,  138 => 45,  135 => 44,  132 => 43,  126 => 40,  119 => 36,  115 => 35,  108 => 31,  104 => 29,  101 => 28,  99 => 27,  95 => 25,  86 => 19,  83 => 18,  80 => 17,  66 => 4,  60 => 3,  11 => 1,);
    }
