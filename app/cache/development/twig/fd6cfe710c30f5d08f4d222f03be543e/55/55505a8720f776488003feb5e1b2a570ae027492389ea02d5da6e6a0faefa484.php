...
class __TwigTemplate_f397461309a6f6f5c0a4f9d638b3517d47e33bdc6b6ceccc655b70679a318118 extends Twig_Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        $tags = array("if" => 229);
        $filters = array("escape" => 239, "e" => 239, "length" => 240, "raw" => 247, "json_encode" => 247);
        $functions = array();

        try {
            $this->env->getExtension('Twig_Extension_Sandbox')->checkSecurity(
                array('if'),
                array('escape', 'e', 'length', 'raw', 'json_encode'),
                array()
            );
            ...
            echo "            if (window.XMLHttpRequest && XMLHttpRequest.prototype.addEventListener) {
                ...
                XMLHttpRequest.prototype.open = function(method, url, async, user, pass) {
                    ...
                    if (url.substr(0, 1) === '/') {
                        if (0 === url.indexOf('";
            // line 239
            echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed(twig_escape_filter($this->env, twig_escape_filter($this->env, $this->getAttribute(($context["request"] ?? null), "basePath", array()), "js"), "html", null, true));
            echo "')) {
                            path = url.substr(";
            // line 240
            echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed(twig_escape_filter($this->env, twig_length_filter($this->env, $this->getAttribute(($context["request"] ?? null), "basePath", array())), "html", null, true));
            echo ");
                        }
                    }
                    else if (0 === url.indexOf('";
            // line 243
            echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed(twig_escape_filter($this->env, twig_escape_filter($this->env, ($this->getAttribute(($context["request"] ?? null), "schemeAndHttpHost", array()) . $this->getAttribute(($context["request"] ?? null), "basePath", array())), "js"), "html", null, true));
            echo "')) {
                        path = url.substr(";
            // line 244
            echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed(twig_escape_filter($this->env, twig_length_filter($this->env, ($this->getAttribute(($context["request"] ?? null), "schemeAndHttpHost", array()) . $this->getAttribute(($context["request"] ?? null), "basePath", array()))), "html", null, true));
            echo ");
                    }

                    if (!path.match(new RegExp(";
            // line 247
            echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed(twig_jsonencode_filter(($context["excluded_ajax_paths"] ?? null)));
            echo "))) {
                        var stackElement = {
                            loading: true,
                            error: false,
...
";
    ...
    {
        return array (  341 => 277,  308 => 247,  302 => 244,  298 => 243,  292 => 240,  288 => 239,  277 => 230,  275 => 229,  49 => 5,  46 => 1,);
    }
...
/*]]>*/</script>
", "@WebProfiler/Profiler/base_js.html.twig", "/var/www/bolt/vendor/symfony/web-profiler-bundle/Resources/views/Profiler/base_js.html.twig");
    }
}
